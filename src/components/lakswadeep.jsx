...
homiee("/")
    ...
    return(
        ...
        <div>
        <h1>this is  laksahdwweepp</h1>
       <button style={{marginLeft:"700px",color:"red"}}  onClick={backkk}>backkk</button>
        </div>
        <img  className="imgsize" src="https://hblimg.mmtcdn.com/content/hubble/img/lakshadweep/mmt/destination/m_Lakshadweep_l_580_870.jpg" alt="reloaded"></img>
