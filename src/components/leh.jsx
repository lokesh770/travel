...
let backkk=()=>{
 homieee("/")
    ...
    return(
        ...
        <img className="imgsize"src="https://hblimg.mmtcdn.com/content/hubble/img/destimg/mmt/activities/m_Leh_destjulimg_2_l_984_1477.jpg" alt="resolve"></img>
